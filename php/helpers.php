 ...
 * @param  string   $image_size         The image size (i.e. native-400).
 *
 * @return void
 */
function the_rwd_image( $image_id, $echo = true, $sizes = '100vw', $use_link = false, $desired_image_size = 'full', $fallback = 'native-2000' ) {
 ...
 * @return void
 */
function the_img_fit_figure( $image_id, $class, $sizes = '100vw', $desired_image_size = 'native-2000', $fallback = 'native-2000', $echo = true, $use_link = false, $use_caption = false ) {
